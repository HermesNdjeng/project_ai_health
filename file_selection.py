...
excel_files = "/Users/hermesndjeng/Documents/Aivancity_M2/AI for Health/project_AI_for_health/VERTEBRAE_HEART_SCALES_ANNOTATIONS_MT.xlsx"
annotated_images_folder = ""
output_folder = ""

df = pd.read_excel(excel_files)
file_names = df["Image file name"].to_list()
